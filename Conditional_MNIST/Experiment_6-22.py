...
sample_probs = {'2':0.9, '7':0} #30% of 2s and 100% of 7s
...
def Aug(train_data, prop_keep, n_epoch = 30, batch_size = 256,  n_T = 200,  device = "cuda:0",
        n_classes = 2,  n_feat = 128,  lrate = 1e-4,  save_model = False,
        save_dir = './data/diffusion_outputs10/', w = .1):
